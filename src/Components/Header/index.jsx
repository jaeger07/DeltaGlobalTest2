...
export default function Header({toggleTheme}) {
    ...
    <Menu>
      ...
      <Switch
        ...
        checkedIcon={<svg width="20" height="20" viewBox="0 0 15 12" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        uncheckedIcon={<svg width="50" height="25" viewBox="1 0.5 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
